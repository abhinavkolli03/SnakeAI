...
class CustomButton(WidgetBase):
    def __init__(self, win, x, y, width, height, isSubWidget=False, **kwargs):
        ...
        self.font = kwargs.get('font', pygame.font.SysFont("bahnschrift", 25))
    ...
    def listen(self, event):
        ...
        if not self._hidden and not self._disabled:
            ...
            if self.contains(x, y):
                if not event[0] and self.clicked:
                    self.clicked = False
                    self.onRelease(*self.onReleaseParams)

                elif event[0] and not self.clicked:
                    self.clicked = True
                    if self.string == "Restart":
    ...
    def createButtons(self):
        ...
        for i in range(across):
            for j in range(down):
                ...
                self.buttons.append(CustomButton(self.win, x, y, width, height, isSubWidget=True,
...
if __name__ == '__main__':
    ...
    button = CustomButton(win, 100, 100, 300, 150, text='Hello', fontSize=50, margin=20,
                    inactiveColour=(255, 0, 0), pressedColour=(0, 255, 0), radius=20,
                    onClick=lambda: print('Click'), font=pygame.font.SysFont("bahnschrift", 25),
